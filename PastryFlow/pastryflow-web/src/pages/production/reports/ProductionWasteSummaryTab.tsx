...
const ProductionWasteSummaryTab: React.FC = () => {
  const { user } = useAuth();
  ...
  const handleExportExcel = () => {
    ...
    exportToExcel({
      fileName: `PastryFlow_Uretim_ZayiatRaporu_${branchId}_${dateRange[0]}_${dateRange[1]}`,
      sheetName: 'Zayiat Özeti',
      title: 'Üretim Zayiat Özet Raporu',
      subtitle: `Tarih Aralığı: ${formatDateRangeForExport(dateRange[0], dateRange[1])} | Şube: ${report.branchName}`,
      columns: [
  ...
  const handleExportPdf = () => {
    ...
    exportToPdf({
      fileName: `PastryFlow_Uretim_ZayiatRaporu_${branchId}_${dateRange[0]}_${dateRange[1]}`,
      title: 'Üretim Zayiat Özet Raporu',
      subtitle: `Tarih: ${formatDateRangeForExport(dateRange[0], dateRange[1])} | Şube: ${report.branchName}`,
      columns: [
...
export default ProductionWasteSummaryTab;
