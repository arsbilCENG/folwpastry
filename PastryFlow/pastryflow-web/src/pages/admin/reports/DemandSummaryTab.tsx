...
const DemandSummaryTab: React.FC = () => {
  ...
  const handleExportExcel = () => {
    if (!report) return;
    exportToExcel({
      fileName: `PastryFlow_TalepRaporu_${dateRange[0]}_${dateRange[1]}`,
      ...
      columns: [
        ...
        { header: 'Reddedilen', key: 'rejectedItems', width: 12 },
            ...
            <Col xs={24} sm={12} md={6}>
              <Card>
                <Statistic
                  ...
                  valueStyle={{ color: getApprovalRateColor(report.approvalRate) }}
                />
              </Card>
            </Col>
          </Row>
