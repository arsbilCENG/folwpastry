...
namespace PastryFlow.Infrastructure.Migrations
{
    ...
    [Migration("20260515234801_Sprint8_CakeOrderPaymentAndReminder")]
    partial class Sprint8_CakeOrderPaymentAndReminder
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("PastryFlow.Domain.Entities.CustomCakeOrder", b =>
                {
                    ...
                    b.Property<Guid?>("DepositCollectedByUserId")
                        .HasColumnType("uuid");

                    b.Property<DateTime?>("DepositPaidAt")
                        .HasColumnType("timestamp with time zone");

                    b.Property<int?>("DepositPaymentMethod")
                        .HasColumnType("integer");
                    ...
                    b.Property<Guid?>("FinalPaymentCollectedByUserId")
                        .HasColumnType("uuid");

                    b.Property<int?>("FinalPaymentMethod")
                        .HasColumnType("integer");

                    b.Property<DateTime?>("FinalPaymentPaidAt")
                        .HasColumnType("timestamp with time zone");
                    ...
                    b.HasIndex("DepositCollectedByUserId");

                    b.HasIndex("FinalPaymentCollectedByUserId");
            ...
            modelBuilder.Entity("PastryFlow.Domain.Entities.CustomCakeOrder", b =>
                {
                    ...
                    b.HasOne("PastryFlow.Domain.Entities.User", "DepositCollectedByUser")
                        .WithMany()
                        .HasForeignKey("DepositCollectedByUserId");

                    b.HasOne("PastryFlow.Domain.Entities.User", "FinalPaymentCollectedByUser")
                        .WithMany()
                        .HasForeignKey("FinalPaymentCollectedByUserId");
                    ...
                    b.Navigation("DepositCollectedByUser");

                    b.Navigation("FinalPaymentCollectedByUser");
