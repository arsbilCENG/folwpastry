...
const ProductionDemandSummaryTab: React.FC = () => {
  const { user } = useAuth();
  ...
  const handleExportExcel = () => {
    ...
    exportToExcel({
      fileName: `PastryFlow_Uretim_TalepRaporu_${branchId}_${dateRange[0]}_${dateRange[1]}`,
      sheetName: 'Talep Özeti',
      title: 'Üretim Talep Özet Raporu',
      subtitle: `Tarih Aralığı: ${formatDateRangeForExport(dateRange[0], dateRange[1])}`,
      columns: [
        { header: 'Tarih', key: 'date', width: 15 },
        { header: 'Gönderen Şube', key: 'fromBranchName', width: 25 },
  ...
  const handleExportPdf = () => {
    ...
    exportToPdf({
      ...
      columns: [
        ...
        { header: 'Gönderen', dataKey: 'fromBranchName' },
...
export default ProductionDemandSummaryTab;
